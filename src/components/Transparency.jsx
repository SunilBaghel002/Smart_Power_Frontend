  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setBlockchainStats((prev) => ({
        ...
        verifiedEnergy:
          prev.verifiedEnergy + Math.floor(Math.random() * 50) + 20,
  ...
  const blockchainRecords = [
    {
      ...
      validatorNodes: 12,
      previousHash:
        "c8e1a4f7b2d9e6c3b8a5f2d7e4c1b6a9f3d8e5c2b7a4f1e9d6c3b8a5f2d7e4c1",
    },
    {
      id: 2,
      blockNumber: 47290,
      ...
      validatorNodes: 15,
      previousHash:
        "f2d9b6c3e8a5d2b7f4e1c8b5a2f9d6e3c8b5a2f7d4e1b8c5a2f9d6e3c8b5a2f7",
    },
    {
      id: 3,
      blockNumber: 47289,
      ...
      validatorNodes: 18,
      previousHash:
        "b5c7a2f9d6e3c8b5a2f7d4e1b8c5a2f9d6e3c8b5a2f7d4e1b8c5a2f9d6e3c8b5",
    },
    {
      id: 4,
      blockNumber: 47288,
      ...
      validatorNodes: 14,
      previousHash:
        "d8e5c2b9f6a3d7e4c1b8a5f2d9e6c3b0a7f4d1e8c5b2a9f6d3e0c7b4a1f8d5e2",
    },
    {
      id: 5,
      blockNumber: 47287,
      ...
      validatorNodes: 11,
      previousHash:
        "a1f8d5e2c9b6a3f0d7e4c1b8a5f2d9e6c3b0a7f4d1e8c5b2a9f6d3e0c7b4a1f8",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <RefreshCw
                  className={`w-5 h-5 ${liveUpdating ? "animate-spin" : ""}`}
                />
              </button>
            </div>
          </div>
      ...
      <section className="py-12 px-6">
        <div className="max-w-7xl mx-auto text-center space-y-6">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Every unit of energy generated is permanently recorded on our
            blockchain. Verify, audit, and trust our immutable energy production
            records.
          </p>
        </div>
      </section>
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 backdrop-blur-lg rounded-2xl p-6 border border-blue-500/30">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <p className="text-2xl font-bold">
                    {blockchainStats.totalRecords.toLocaleString()}
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-purple-600/20 backdrop-blur-lg rounded-2xl p-6 border border-purple-500/30">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <p className="text-2xl font-bold">
                    {blockchainStats.verifiedEnergy.toLocaleString()}
                  </p>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">
                        {record.stepCount.toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-400 text-xs uppercase">
              ...
              {selectedRecord ? (
                  ...
                  <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-black/20 rounded-lg p-4">
                        ...
                        <p className="text-2xl font-bold">
                          {selectedRecord.stepCount.toLocaleString()}
                        </p>
                  ...
                  <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-semibold">
                          {selectedRecord.validatorNodes} nodes
                        </span>
                      </div>
                ...
                <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-12 border border-white/10 text-center">
                  ...
                  <p className="text-gray-400">
                    Click on any blockchain record to view detailed information
                  </p>
                </div>
              )}
          ...
          <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 backdrop-blur-lg rounded-3xl p-8 border border-green-500/20">
            <div className="text-center mb-8">
              <h3 className="text-3xl font-bold mb-4">
                Why Trust Our Transparency?
              </h3>
              <p className="text-gray-300 max-w-2xl mx-auto">
                Our blockchain infrastructure ensures complete data integrity
                and transparency through cutting-edge cryptographic security.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-400">
                  Once data is recorded on our blockchain, it cannot be altered,
                  deleted, or tampered with by anyone.
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-400">
                  Multiple validator nodes verify each transaction, ensuring
                  consensus and preventing single points of failure.
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-400">
                  All energy production data is publicly accessible and
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                ...
                <p className="text-gray-300">
                  Integrate our transparency data into your applications with
                  our comprehensive REST API. Access real-time blockchain data,
                  verify records, and build trust into your systems.
                </p>
